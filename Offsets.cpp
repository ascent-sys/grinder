...
constexpr long OFF_LOCAL_ORIGIN = 0x017c;                     //[DataMap.CBaseViewModel]->m_localOrigin (0x0188)  / [DataMap.CBaseViewModel]->m_vecAbsOrigin (0x017c)
constexpr long OFF_TEAM_NUMBER = 0x030c;                      //[RecvTable.DT_BaseEntity]->m_iTeamNum
constexpr long OFF_CURRENT_HEALTH = 0x02fc;                   //[RecvTable.DT_BaseEntity]->m_iHealth (0x036c) / [RecvTable.DT_Player]->m_iHealth (0x02fc) ?
...
//weapon
constexpr long OFF_WEAPON_HANDLE = 0x18f4;                    //[RecvTable.DT_Player]->m_latestPrimaryWeapons / [RecvTable.DT_BaseCombatCharacter]->m_latestPrimaryWeapons ?
